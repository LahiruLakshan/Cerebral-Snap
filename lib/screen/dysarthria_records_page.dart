...
class DysarthriaRecordsPage extends StatefulWidget {
  ...
  const DysarthriaRecordsPage({Key? key,  this.currentUser}) : super(key: key);

  @override
  State<DysarthriaRecordsPage> createState() => _DysarthriaRecordsPageState();
}

class _DysarthriaRecordsPageState extends State<DysarthriaRecordsPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text("Audio Records", style: TextStyle(color: AppTheme.colors.blue),),
                                    ...
                                    child: Column(
                                      ...
                                      children: <Widget>[
                                        Container(
                                          ...
                                          child: Flexible(
                                            child: Text(
                                              "Detection : ${tumorRecord["dysarthriaDetection"]}",
                                              style: TextStyle(
                                                fontSize: 18.0,
                                ...
                                Positioned(
                                  ...
                                  child: ClipRRect(
                                    ...
                                    child: CachedNetworkImage(
                                      imageUrl: "https://firebasestorage.googleapis.com/v0/b/cerebral-snap.appspot.com/o/audio%20x%20generic.png?alt=media&token=ae26e8ef-f648-474f-9a7c-4525d917d954",
                                      width: 110.0,
                                      fit: BoxFit.cover,
